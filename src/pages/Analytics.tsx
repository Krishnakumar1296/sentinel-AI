        ...
        >
          <div className="mx-auto max-w-xs space-y-3 text-sm">
            ...
            <div className="flex justify-between">
              ...
              <span className="font-semibold text-ink">Manager / Admin</span>
            </div>
          </div>
        </ErrorState>
      </div>
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <StatCard icon={CheckCircle2} label="Successful Answers" value={data.successfulAnswers.toLocaleString()} delta="95% success rate" iconClass="bg-green-50 text-green-600 dark:bg-green-500/10 dark:text-green-400" />
        <StatCard icon={XCircle} label="Failed Queries" value={data.failedQueries.toLocaleString()} delta="Tracked as gaps" positive={false} iconClass="bg-red-50 text-red-500 dark:bg-red-500/10 dark:text-red-400" />
        <StatCard icon={Timer} label="Avg Response Time" value={`${data.avgResponseTime} sec`} delta="Fast" iconClass="bg-amber-50 text-amber-500 dark:bg-amber-500/10 dark:text-amber-400" />
      </div>
        ...
        <div className="flex flex-col items-center gap-6 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="relative h-32 w-32">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center">
              <span className="text-2xl font-bold text-ink">{data.faithfulnessScore}%</span>
